...
object WordCount {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df_wordCount = sc.textFile("/softwares/spark/README.md")
    ...
    val df_wordCount_light = sc.textFile("/softwares/spark/README.md")
    ...
    val df_wordCount_lighter = sc.textFile("/softwares/spark/README.md") // output RDD of lines : RDD[String]
    ...
    val df_wordCount_lightest = sc.textFile("/softwares/spark/README.md")
      .flatMap(_.split(" "))
      .map((_, 1))
      .reduceByKey(_ + _)
      .toDF("word", "count")
